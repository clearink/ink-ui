...
\`\`\`
`,desc:{"zh-CN":"按钮分为 主要按钮、次要按钮、虚线按钮、线形按钮和文本按钮五种。","en-US":"按钮分为 主要按钮、次要按钮、虚线按钮、线形按钮和文本按钮五种。 en-US"},element:n.jsx(o,{})},{title:"长按钮",rawText:`\`\`\`tsx
import { Button, Space } from '@ink-ui/core'
...
\`\`\`
`,desc:{"zh-CN":"block","en-US":"block en-US"},element:n.jsx(a,{})},{title:"危险",rawText:`\`\`\`tsx
import { Button, Space } from '@ink-ui/core'
