import { getTargetElement, withDisplayName } from '@comps/_shared/utils'
...
import { type PortalProps, type PortalRef } from './props'
...
export default forwardRef(withDisplayName(Portal))
