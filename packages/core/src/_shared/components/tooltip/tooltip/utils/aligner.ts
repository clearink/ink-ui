import type { PopupPlacement } from '@mink-ui/core/_shared/types'

import { fallback, isArray, isObject, isUndefined, ownerDocument } from '@mink-ui/shared'
...
import { getElementCoords, getPositionedCoords } from '../../utils/elements'
